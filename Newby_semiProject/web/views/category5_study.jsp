                ...
                <ul id="shcaul1">
                    ...
                    <li class="cate_tt_sh"  id="title5">
                        <a href="category5_study.jsp">
                            <div id="cate5" style="font-weight: 600;"><div class="tt_circle" id="ttc5"></div>교육</div>
                        </a>
                    </li>
                    <li class="cate_tt_sh1" >
                        <a >
        ...
        <div class="con-wrap">
            ...
            <div class="container_a">
                ...
                <a href="" class="content_a" id="con_0" href="#">
                    <div class="content_a_back" style=" background-image: url('https://t1.daumcdn.net/cfile/tistory/2650993A56E182A80F')"></div>
            ...
            <br>
            <div class="moreBtnSh" id="mbtn_sh"> 교육 클래스 전체보기 </div>
            <br>
