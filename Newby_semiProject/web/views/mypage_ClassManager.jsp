...
<head>
    ...
    <link rel="stylesheet" href="./resources/css/mypage_ClassManager.css">
...
<body>
        ...
        <center>
            ...
            <div id="newby-body-panel" class="contents-div123" align="left">
                ...
                <div id="mn16s" align="center">
                    ...
                    <br>
                    <h2>클래스 관리</h2>      <!-- 제목란이니깐 해당 제목 작성해서 하면 돼-->
                    <br>
                    <hr id="hrSet53">
                    <br>
                    <br>
    ...
    <script>
        ...
        $('.modify1sd').click(function(){
            window.open("./ModifyClass.html","클래스 수정","width=1000, height=650");
        });
    </script>
</body>
</html>