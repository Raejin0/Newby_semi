                ...
                <ul id="shcaul1">
                    ...
                    <li class="cate_tt_sh"  id="title1">
                        <a href="category1_static.jsp">
                            <div id="cate1" style="font-weight: 600;"><div class="tt_circle" id="ttc1" ></div>정적 액티비티</div>
                        </a>
                    </li>
                    <li class="cate_tt_sh1" >
                        <a >
        ...
        <div class="con-wrap">
            ...
            <div class="container_a">
                ...
                <a href="" class="content_a" id="con_0" href="#">
                    <div class="content_a_back" style=" background-image: url('http://ojsfile.ohmynews.com/STD_IMG_FILE/2012/1030/IE001508380_STD.jpg')"></div>
            ...
            <br>
            <div class="moreBtnSh" id="mbtn_sh"> 정적 액티비티 전체보기 </div>
            <br>
