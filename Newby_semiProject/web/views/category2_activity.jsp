                ...
                <ul id="shcaul1">
                    ...
                    <li class="cate_tt_sh"  id="title2">
                        <a href="category2_activity.jsp">
                            <div id="cate2" style="font-weight: 600;"><div class="tt_circle" id="ttc2" ></div>액티비티</div>
                        </a>
                    </li>
                    <li class="cate_tt_sh1" >
                        <a >
        ...
        <div class="con-wrap">
            ...
            <div class="container_a">
                ...
                <a href="" class="content_a" id="con_0" href="#">
                    <div class="content_a_back" style=" background-image: url('https://img1.daumcdn.net/thumb/R800x0/?scode=mtistory2&fname=https%3A%2F%2Ft1.daumcdn.net%2Fcfile%2Ftistory%2F24091E5058DBA97F21')"></div>
            ...
            <br>
            <div class="moreBtnSh" id="mbtn_sh"> 액티비티 클래스 전체보기 </div>
            <br>
